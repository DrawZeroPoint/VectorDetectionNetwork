...
def save_batch_image_with_joints(batch_image, joints_preds, file_name, expand=1, nrow=8, padding=0):
    """
    """
...
def save_debug_images(config, input, meta, target, joints_pred, output, prefix):
    ...
    if config.DEBUG.SAVE_BATCH_IMAGES_PRED:
        save_batch_image_with_joints(input, joints_pred, '{}_pred.jpg'.format(prefix), expand=4)
