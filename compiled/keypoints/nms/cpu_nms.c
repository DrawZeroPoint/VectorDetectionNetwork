...
static char __pyx_k_home_kilox_My_pro_human_pose_es[] = "/home/kilox/My_pro/human-pose-estimation.pytorch/lib/nms/cpu_nms.pyx";
 ...
 */
  ...
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(2, 0, 29, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_kilox_My_pro_human_pose_es, __pyx_n_s_cpu_nms, 16, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
